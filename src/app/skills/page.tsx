...
const skillTree: FileNode[] = [
  {
    name: "applause-outbound-engine/",
    type: "folder",
    icon: "folder",
    color: "#00579f",
    description: "Root project directory. Contains the CLAUDE.md skill definition and all stage prompt files.",
    children: [
      {
        name: "CLAUDE.md",
        type: "file",
      ...
      },
      {
        ...
        icon: "folder",
        color: "#2db87e",
        description: "Stage-specific prompt files. Each file contains the full system prompt and output schema for one pipeline stage.",
        children: [
          {
            name: "01-forensic-research-analyst.md",
            type: "file",
            icon: "search",
            color: "#7c6bc4",
            description:
              "Stage 1 prompt. Instructs Claude to act as a forensic B2B research analyst. Scans for buying signals, competitive landscape, pain discovery, and market triggers. Returns structured signal cards with priority scores.",
            preview: [
          ...
          {
            name: "02-strategic-icp-builder.md",
            type: "file",
            icon: "person_search",
            color: "#2db87e",
            description:
              "Stage 2 prompt. Builds ideal customer profiles and persona matrices. Enriches leads with data quality scores and intent signals. Classifies each contact by enrichment status.",
            preview: [
          ...
          {
            name: "03-lead-research-agent.md",
            type: "file",
            icon: "leaderboard",
            color: "#4a90d9",
            description:
              "Stage 3 prompt. Deep research on approved leads. Classifies by buyer role (Economic Buyer, Technical Buyer, Champion, Influencer) and maps specific pain points to each person for personalized outreach.",
            preview: [
              "# Lead Research Agent",
              "",
              "## Role",
          ...
          {
            name: "04-cold-messaging-pro.md",
            type: "file",
            icon: "mail",
            color: "#d4843e",
            description:
              "Stage 4 prompt. Generates the full multi-channel outbound cadence. Writes emails (120 words max), LinkedIn messages (75 words max), and phone talk tracks (30 seconds max). Enforces all cadence rules from CLAUDE.md.",
            preview: [
              "# Cold Messaging Pro",
              "",
              "## Role",
              ...
              "",
              "## Output Schema",
              "Return Touchpoint objects with:",
              "day, channel, title, description, metadata[]",
            ],
          },
          {
            name: "05-output-compiler.md",
            type: "file",
            icon: "download",
            color: "#c94e7c",
            description:
              "Stage 5 prompt. Compiles all pipeline outputs into a single deliverable document. Formats for Google Drive upload. Phase 2 will add direct SalesLoft push.",
            preview: [
              "# Output Compiler",
              "",
              "## Role",
